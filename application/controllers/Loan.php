...
class Loan extends CI_Controller {
	...
	public function approved_loans(){
		...
		$title['title'] = "SMD-Approved Loans";
	...
	public function promissory($loan_no=""){
		...
		if($loan != ''){
			...
			if(!is_null($result)){
				...
				$title['title'] = "SMD-Promissory Note";
	...
	public function rejected_loans(){
		...
		$title['title'] = "SMD-Rejected Loans";
		...
		if($insert_data){
			...
			if($email_notif == 'yes'){
				if(filter_var($email, FILTER_VALIDATE_EMAIL)){
					...
					$subject = "SMD Loan Application Verification";
	...
	public function approve_loan(){
		...
		if($query){
			...
			if($result){
				...
				$subject = "SMD Loan Application Approval";
